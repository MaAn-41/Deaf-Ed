...
const UrduReportScreen = ({ route }) => {
  ...
  const filteredResults = results.filter(
    (item) => selectedLetter === "" || item.letter === selectedLetter
  );
          ...
          <>
            {!showDetails ? (
              ...
              <>
                ...
                {selectedLetter && correctFilteredResults.length > 0 ? (
                  <>
                    <Text style={styles.chartTitle}>
...
export default UrduReportScreen;
