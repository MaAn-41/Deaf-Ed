...
const RemoveStudentScreen = ({ route }) => {
  ...
  const fetchSections = async () => {
    ...
    try {
      const response = await fetch(
        `http://192.168.137.128:5000/sections?educatorUsername=${educatorUsername}`
      );
  ...
  const fetchStudents = async () => {
    ...
    try {
      const response = await fetch(
        `http://192.168.137.128:5000/students?educatorUsername=${educatorUsername}&section=${selectedSection}`
      );
      const data = await response.json();
      if (response.ok) {
  ...
  const handleRemoveStudent = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.137.128:5000/remove-student`, {
        method: 'POST',
